                    ...
                    <div className={styles.history__container}>
                            ...
                            if (e.trade) {
                                return (
                                    ...
                                    >
                                        <div
                                            className={
                                                styles.history__event__container
                                            }
                                        >
                                            <svg
                                                width="16"
                                        ...
                                        >
                                            ...
                                            <div
                                                className={
                                                    styles.history__price
                                                }
                                            >
                                                {parseFloat(e.swap.price / 1e6)}{' '}
                                                tez
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className={styles.history} key="mint-op">
                            <div className={styles.history__event__container}>
                                ...
                                <div className={styles.history__mint__op}>
                                    minted
                                </div>
                            </div>
                            ...
                            <div className={styles.history__from}>
                                {token_info.creator.name ? (
                                    ...
                                    <span>
                                        <a
                                            href={`/tz/${token_info.creator.address}`}
                                        >
                                            <Primary>
                                                {walletPreview(
                                                    token_info.creator.address
