                ...
                <div className={styles.content}>
                    <Button onClick={() => handleRoute('/')}>
                        <div className={styles.logo}>
                            ...
                            {/* PRIDE LOGO */}
                            {false && (
                                <img src="/hen-pride.gif" alt="pride 2021" />
                            )}
                        </div>
                    </Button>
                                ...
                                <nav className={styles.content}>
                                    ...
                                    {context.acc?.address ? (
                                        ...
                                        <ul>
                                            <div
                                                className={
                                                    styles.no__address__text
                                                }
                                            >
                                                The present decentralized
                                                application allows its users to
                                                manage decentralized digital
                                                assets, serving as a public
                                                smart contract infrastructure on
                                                Tezos Blockchain.
                                            </div>
                                        </ul>
                                    )}
